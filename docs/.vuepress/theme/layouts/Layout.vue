    ...
    export default {
        ...
        computed: {
            ...
            showPageSidebar() {
                ...
                const home = this.$page.frontmatter.home

                const pageSelfNotShow = this.$page.frontmatter.isShowPageSidebar

                const globalShowPageSidebar = this.$themeConfig.globalShowPageSidebar

                if (globalShowPageSidebar === false) {
                    return false
                }
                if (pageSelfNotShow === false) {
                    return false
                }
                if (home ===true){
                    return false
